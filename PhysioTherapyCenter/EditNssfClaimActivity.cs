...
namespace PhysioTherapyCenter
{
    ...
    [Activity(Label = "Edit Nssf Claim", Theme = "@style/AppTheme.NoActionBar")]
    public class EditNssfClaimActivity : BaseDrawerActivity
    {
        ...
        private NssfPatientClaim entity = new NssfPatientClaim { };
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.edit_nssf_claim);
            ...
            edit_text_code = FindViewById<EditText>(Resource.Id.edit_text_code);
            ...
            if (Intent.Extras != null)
            {
                ...
                if (!string.IsNullOrEmpty(ClaimId))
                {
                    ...
                    entity = await GetNssfClaim(ClaimId);
                    ...
                    if (entity != null)
                    {
                        ...
                        edit_text_claim_guarantor.Text = entity.Guarantor;
                        ...
                        text_view_relationship.Text = entity.Relationship;
                        ...
                        text_view_doctor.Text = entity.DoctorName;
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            {
                var NssfPatientClaimId = entity.NssfPatientClaimId;
                DeleteNssfPatientClaimAsync(NssfPatientClaimId);
            }

            return true;
        }

        private async Task DeleteNssfPatientClaimAsync(string NssfPatientClaimId)
        {

            var isDeleted = false;


            if (!string.IsNullOrEmpty(NssfPatientClaimId))
            {
                var progressDialog = new ProgressDialog(this);
                progressDialog.SetCancelable(false);
                ...
                var url = string.Format("{0}/api/nssfpatientclaims/{1}", Constants.Server_Url, NssfPatientClaimId);
        ...
        protected async void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            entity.Code = edit_text_code.Text;
            ...
            var url = string.Format("{0}/api/NssfPatientClaims", Constants.Server_Url);
        ...
        List<string> ValidateModel()
        {
            ...
            if (string.IsNullOrEmpty(entity.Code)) { result.Add("Code is required"); }
