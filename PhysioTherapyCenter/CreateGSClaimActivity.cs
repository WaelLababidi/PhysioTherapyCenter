...
namespace PhysioTherapyCenter
{
    ...
    [Activity(Label = "Create GS Claim", Theme = "@style/AppTheme.NoActionBar")]
    public class CreateGSClaimActivity : BaseDrawerActivity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.create_gs_claim);
