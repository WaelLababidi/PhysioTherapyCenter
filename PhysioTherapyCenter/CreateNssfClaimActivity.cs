...
namespace PhysioTherapyCenter
{
    ...
    [Activity(Label = "Create Nssf Claim", Theme = "@style/AppTheme.NoActionBar")]
    public class CreateNssfClaimActivity : BaseDrawerActivity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.create_nssf_claim);
