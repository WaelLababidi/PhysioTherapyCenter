...
namespace PhysioTherapyCenter
{
    ...
    [Activity(Label = "Edit GS Claim", Theme = "@style/AppTheme.NoActionBar")]
    public class EditGSClaimActivity : BaseDrawerActivity
    {
        private TextView text_view_patient;
        private EditText edit_text_claim_number;
        private EditText edit_text_claim_guarantor;
        private TextView text_view_relationship;
        private EditText edit_text_military_number;
        private TextView text_view_rank;
        ...
        private TextView text_view_physical_therapists;
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.edit_gs_claim);
            ...
            if (Intent.Extras != null)
            {
                ...
                if (!string.IsNullOrEmpty(ClaimId))
                {
                    ...
                    entity = await GetGSClaim(ClaimId);
                    ...
                    if (entity != null)
                    {
                        ...
                        text_view_relationship = FindViewById<TextView>(Resource.Id.text_view_relationship);
                        edit_text_military_number = FindViewById<EditText>(Resource.Id.edit_text_military_number);
                        text_view_rank = FindViewById<TextView>(Resource.Id.text_view_rank);
                        ...
                        text_view_physical_therapists = FindViewById<TextView>(Resource.Id.text_view_physical_therapists);
        ...
        private async Task DeleteISPatientClaimAsync(string InternalSecurityPatientClaimId)
        {
            ...
            if (!string.IsNullOrEmpty(InternalSecurityPatientClaimId))
            {
                ...
                var url = string.Format("{0}/api/gsclaims/{1}", Constants.Server_Url, InternalSecurityPatientClaimId);
        ...
        protected async void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            var url = string.Format("{0}/api/gsclaims", Constants.Server_Url);
