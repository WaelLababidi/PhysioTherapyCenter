...
namespace PhysioTherapyCenter
{
    ...
    [Activity(Label = "Create IS Claim", Theme = "@style/AppTheme.NoActionBar")]
    public class CreateISClaimActivity : BaseDrawerActivity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.create_is_claim);
            ...
            //test_test.Click += delegate
            //{
            //    searchPatientDialogFragment = new SearchPatientDialogFragment(patients, SearchPatientDialogFragment_CallBackAction);
            //    searchPatientDialogFragment.Show(FragmentManager, "SEARCH_PATIENT_DIALOG_TAG");
            //};

            //text_view_patient.Click += TestClick;
            //text_view_patient.LongClick += text_view_patient_LongClick;
            ...
            text_view_physical_therapists.Text = "Fida Lababidi";
            entity.PhysicalTherapistId = "73c215a8088d4ab3b18df78e82ed2897";
            ...
            //entity.ApprovalDate_Update = DateTime.Now;
        ...
        //private void text_view_patient_FocusChange(object sender, View.FocusChangeEventArgs e)
        //{
        //    if (e.HasFocus)
        //    {
        ...
        //private void text_view_patient_LongClick(object sender, EventArgs e)
        //{
        //    searchPatientDialogFragment = new SearchPatientDialogFragment(patients, SearchPatientDialogFragment_CallBackAction);
        //    searchPatientDialogFragment.Show(FragmentManager, "SEARCH_PATIENT_DIALOG_TAG");
        //}
