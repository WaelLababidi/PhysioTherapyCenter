...
public class ClaimsActivity_FabAnimatorListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PhysioTherapyCenter.ClaimsActivity+FabAnimatorListener, PhysioTherapyCenter", ClaimsActivity_FabAnimatorListener.class, __md_methods);
	}


	public ClaimsActivity_FabAnimatorListener ()
	{
		super ();
		if (getClass () == ClaimsActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("PhysioTherapyCenter.ClaimsActivity+FabAnimatorListener, PhysioTherapyCenter", "", this, new java.lang.Object[] {  });
	}

	public ClaimsActivity_FabAnimatorListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == ClaimsActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("PhysioTherapyCenter.ClaimsActivity+FabAnimatorListener, PhysioTherapyCenter", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
