...
{
    public class SearchDoctorDialogFragment : DialogFragment
    {
        ...
        private List<DoctorViewModel> Items;

        private Action<DoctorViewModel> CallBackAction;

        public SearchDoctorDialogFragment(List<DoctorViewModel> items, Action<DoctorViewModel> callBackAction)
        {
            Items = items;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            adapter = new DoctorAdapter(this.Activity, Items);
            lv.Adapter = adapter;
        ...
        private void sv_QueryTextChange(object sender, SearchView.QueryTextChangeEventArgs e)
        {
            ...
            {
                adapter = new DoctorAdapter(this.Activity, Items.Where(x => x.EnglishDoctorName.ToLower().Contains(e.NewText.ToLower())).ToList());
                lv.Adapter = adapter;
            }
