...
{
    public class SearchRankDialogFragment : DialogFragment
    {
        ...
        private List<RankViewModel> Items;

        private Action<RankViewModel> CallBackAction;

        public SearchRankDialogFragment(List<RankViewModel> items, Action<RankViewModel> callBackAction)
        {
            Items = items;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            adapter = new RankAdapter(this.Activity, Items);
            lv.Adapter = adapter;
        ...
        private void sv_QueryTextChange(object sender, SearchView.QueryTextChangeEventArgs e)
        {
            ...
            {
                adapter = new RankAdapter(this.Activity, Items.Where(x => x.ArabicMilitaryRankName.ToLower().Contains(e.NewText.ToLower())).ToList());
                lv.Adapter = adapter;
            }
