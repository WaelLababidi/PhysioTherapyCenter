...
namespace PhysioTherapyCenter
{
    ...
    [Activity(Label = "Edit Coop Claim", Theme = "@style/AppTheme.NoActionBar")]
    public class EditCoopClaimActivity : BaseDrawerActivity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            if (Intent.Extras != null)
            {
                ...
                if (!string.IsNullOrEmpty(ClaimId))
                {
                    ...
                    entity = await GetCoopClaim(ClaimId);
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            {
                var CoopPatientClaimId = entity.CoopPatientClaimId;
                DeleteCoopPatientClaimAsync(CoopPatientClaimId);
            }

            return true;
        }

        private async Task DeleteCoopPatientClaimAsync(string CoopPatientClaimId)
        {

            var isDeleted = false;


            if (!string.IsNullOrEmpty(CoopPatientClaimId))
            {
                var progressDialog = new ProgressDialog(this);
                progressDialog.SetCancelable(false);
                ...
                var url = string.Format("{0}/api/cooppatientclaims/{1}", Constants.Server_Url, CoopPatientClaimId);
